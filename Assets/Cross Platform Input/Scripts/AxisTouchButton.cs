...
public class AxisTouchButton : MonoBehaviour {
	...
	void Start(){
		...
		leftButton.pixelInset = new Rect (screenWidth/10, 0, screenWidth/4, screenWidth/4);
		rightButton.pixelInset = new Rect (screenWidth* 0.9f - screenWidth/4, 0, screenWidth/4, screenWidth/4);
		Debug.Log (screenWidth / 40);
